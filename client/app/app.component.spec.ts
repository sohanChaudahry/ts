...
describe('Component: App', () => {
  ...
  it('should display the navigation bar correctly for guests', () => {
    ...
    expect(de[4].nativeElement.textContent).toContain('GreenHouseType');
    expect(de[5].nativeElement.textContent).toContain('GreenHouse');
    expect(de[6].nativeElement.textContent).toContain('Activities');
    ...
    expect(de[4].attributes['routerLink']).toBe('/greenHouseType');
    expect(de[5].attributes['routerLink']).toBe('/greenHouse'); 
    expect(de[6].attributes['routerLink']).toBe('/activities');
  ...
  it('should display the navigation bar correctly for admin users', () => {
    ...
    expect(de[5].nativeElement.textContent).toContain('greenHouseType');
    expect(de[6].nativeElement.textContent).toContain('greenHouse');
    expect(de[7].nativeElement.textContent).toContain('Activities');
    ...
    expect(de[5].attributes['routerLink']).toBe('/greenHouseType');
    expect(de[6].attributes['routerLink']).toBe('/greenHouse');
    expect(de[7].attributes['routerLink']).toBe('/activities');
